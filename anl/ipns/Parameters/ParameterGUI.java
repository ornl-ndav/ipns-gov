...
public abstract class ParameterGUI implements IParameterGUI, 
                                                 Serializable 
{
  ...
  protected  IObserverList  observers;
   ...
   * @param  valid   Specifies whether or not the valid flag for this 
   *                 PG should be valid initially.
   */
  public ParameterGUI( String name, boolean valid ) 
  {
    this.name  = name;
    this.valid = valid;
  ...
  public void validateSelf()
  {
    try
    {
      getValue();  // this will throw an exception if there is a problem
      setValidFlag( true ); 
    }
    catch ( Exception e )
    {
  ...
  {
    setValidFlag( false );
    observers.notifyIObservers( this, VALUE_CHANGING );
  } 
  ...
  {
    setValidFlag( false );
    observers.notifyIObservers( this, VALUE_CHANGED );
  }
