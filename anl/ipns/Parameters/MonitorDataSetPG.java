 ...
 *
 */
public class MonitorDataSetPG extends DataSetChoiceListPG {
    ...
    */
   public MonitorDataSetPG( String name, Object val ) throws IllegalArgumentException {
      super( name, val, Attribute.MONITOR_DATA );
   }
   ...
   public Object getCopy() {
      ...
      MonitorDataSetPG copy = new MonitorDataSetPG( getName(), ds_value );
