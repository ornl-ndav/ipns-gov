...
public class FileStrokeFont extends StrokeFont
{
  ...
  public static void main( String args[] )
  {
    ...
    ps.println(" *");
    ps.println(" * $Log$
    ps.println(" * Revision 1.3  2004/06/02 14:14:15  dennis
    ps.println(" * Added java docs for main() method.  Now writes GPL and java doc
    ps.println(" * information into the java font files generated by the main() method.
    ps.println(" * Now makes font files for package .../GL_ThreeD/Fonts.
    ps.println(" *");
    ps.println(" *");
    ps.println(" */");
    ps.println();
    ...
    ps.println();
    ps.println("import gov.anl.ipns.ViewTools.Panels.GL_ThreeD.*;");
    ps.println();
    ps.println("/**");
