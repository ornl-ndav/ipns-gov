 ...
 *
 *  $Log$
 *  Revision 1.3  2005/08/04 22:25:42  cjones
 *  Fixed comment headers.
 *
 *  Revision 1.2  2005/07/22 19:48:39  cjones
    ...
    for(int i = 0; i < 10; i++)
      for(int j = 0; j < 10; j++)
      {
      	data[0].set(i*10+j, // Index
      			  new Vector3D(i*50, -100, j*50), // 3D Coordinates
    ...
    for(int i = 0; i < 10; i++)
      for(int j = 0; j < 10; j++)
      {
        data[1].set(i*10+j, // Index 
        		  new Vector3D(i*50, 600, j*50), // 3D Coordinates
    ...
    for(int i = 0; i < 10; i++)
      for(int j = 0; j < 10; j++)
      {
        data[2].set(i*10+j, // Index
			      new Vector3D(i*50, j*50, -100), // 3D Coordinates
